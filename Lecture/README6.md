...
- Когато ламбда изразите не използват локални променливи, дефинирани извън самия израз, ламбда изразът е non-captured
- А в противен случай се нарича captured или closure
